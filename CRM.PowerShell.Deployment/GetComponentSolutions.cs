...
{
    [Cmdlet(VerbsCommon.Get, "ComponentSolutions")]
    [OutputType(typeof(List<Guid>))]
    public class GetComponentSolutionsCmdlet : Cmdlet
    {
        [Parameter(Position = 0, Mandatory = false)]
        public string FromVersion
        {
            get { return fromVersion; }
        ...
        protected override void ProcessRecord()
        {
            ...
            WriteObject(new List<Guid> { Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid() });
        }
    }
}
