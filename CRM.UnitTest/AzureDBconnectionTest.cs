...
namespace CRM.UnitTest
{
    ...
    public class AzureDBconnectionTest
    {
        ...
        {
            var connectionstring = "Server=tcp:xxxxxxxx.database.windows.net,1433;Initial Catalog=TcCrmDataExport;Persist Security Info=False;User ID=;Password=;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Authentication='Active Directory Password';";
