...
namespace CRM.UnitTest
{
    ...
    public class AzureDBconnectionTest
    {
        ...
        {
            var connectionstring = "Server=tcp:tccrmdev.database.windows.net,1433;Initial Catalog=TcCrmDataExport;Persist Security Info=False;User ID=tcgdynamicscrmnoprd@thomascook.onmicrosoft.com;Password=9L%$!AIOps$$;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Authentication='Active Directory Password';";
