...
Set-BusinessRuleOrder `
 -CrmSourceConnectionString "Url=https://thomascookdev.crm4.dynamics.com;Username=;Password=;authtype=Office365" `
 -CrmTargetConnectionString "Url=https://thomascookstaging.crm4.dynamics.com;Username=;Password=;authtype=Office365" `
 ...
 # - Command line arguments: -NoLogo -NoExit -Command "Import-Module .\TC.PowerShell.Maintenance.dll -Force; Set-BusinessRuleOrder -CrmSourceConnectionString 'Url=https://thomascookdev.crm4.dynamics.com;Username=;Password=;authtype=Office365' -CrmTargetConnectionString 'Url=https://thomascooksit.crm4.dynamics.com;Username=;Password=;authtype=Office365' -EntityName 'tc_compensation'";